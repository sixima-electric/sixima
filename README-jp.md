...
**SIXIMA（シキシマ）** というプロジェクトの名称は、日本の古称・雅称である「敷島（しきしま）」をルーツとしています。「敷き広げられた島々（大地）」を意味するこの言葉には、私たちが掲げる最も重要なミッションが込められています。

> **「誰一人取り残さない、普遍的なデジタル基盤を敷き広げる」**

現代のWebは豊かになった一方で、最大多数の幸福に基づいた「ユニバーサルデザイン」を強要することで、視覚・身体・認知に多様な特性を持つ多くの人々をデジタルの恩恵から取り残してきました。人がソフトウェアの枠組みに無理をして合わせる時代は、もう終わらせなければなりません。
